...
<Card title="Open the hosted viewer" icon="play" href="https://screenjson.com/viewer/">
  Read any ScreenJSON document in the browser — drop a file, paste a URL, or deep-link with <code>?src=</code>. Powered by [screenjson-ui](/tools/ui/overview).
</Card>
