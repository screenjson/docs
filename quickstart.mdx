...
The hosted viewer at [screenjson.com/viewer/](https://screenjson.com/viewer/)
renders any ScreenJSON document as a Final Draft / WriterDuet-style
screenplay. Drop your file in, paste a URL, or deep-link with `?src=`:
